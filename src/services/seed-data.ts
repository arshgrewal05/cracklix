...
export async function seedInitialData(db: Firestore) {
  ...
  const boards = [
    ...
    { id: 'police', name: 'Punjab Police Recruitment', abbreviation: 'Police', description: 'District and Armed Cadre recruitment.', iconUrl: 'https://picsum.photos/seed/police/200/200' },
  ];
  ...
  const exams = [
    { 
      id: 'psssb-patwari', boardId: 'psssb', name: 'Revenue Patwari', category: 'Revenue', 
      description: 'Major state recruitment for revenue department.',
      totalMocks: 45, activeQuestions: 1200, duration: 120
    },
    { 
      id: 'police-constable', boardId: 'police', name: 'Constable 2026', category: 'Police', 
      description: 'District Cadre SI/Constable recruitment.',
      totalMocks: 30, activeQuestions: 3000, duration: 120
    },
  ];
  ...
  const questions = [
    {
      id: 'q-seed-1', boardId: 'psssb', examId: 'psssb-patwari', subjectId: 'punjab-gk', difficulty: 'easy',
  ...
  const mocks = [
    {
      id: 'mock-seed-1', title: 'Patwari Mini Mock 01', boardId: 'psssb', examId: 'psssb-patwari',
      mockType: 'FULL', duration: 10, totalQuestions: 1, questionIds: ['q-seed-1'],
      difficulty: 'Easy', published: true, createdAt: serverTimestamp()
    }
  ];
  ...
  // 6. Current Affairs
  const ca = [
    { id: 'ca-seed-1', title: 'Punjab Solar Policy 2026', summary: 'New initiative to boost green energy.', category: 'Punjab', date: '28 Oct 2026', createdAt: serverTimestamp() }
  ];
  for (const article of ca) await setDoc(doc(db, 'current_affairs', article.id), article);

  // 7. Notifications
  const notifications = [
    { id: 'notif-seed-1', title: 'PSSSB Result Declared', message: 'Patwari 2025 Final List is live.', category: 'Result', board: 'PSSSB', time: '10m ago', important: true, createdAt: serverTimestamp() }
  ];
