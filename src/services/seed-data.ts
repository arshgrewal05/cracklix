...
/**
 * @fileOverview Institutional Seeding Engine v61.0.
 * Features: High-Fidelity Verified Official Logos for Punjab & National Exam Hubs.
 * UPDATED: Fixed CTET and IBPS logos as mandatory institutional nodes with exact registry ID matching.
 */
export async function seedInitialData(db: Firestore) {
  ...
  const exams = [
    // CTET VERTICALS (Corrected Branding & IDs to match User Hub)
    { id: 'ctet-1', boardId: 'cbse', name: 'CTET Paper 1', category: 'TEACHING', description: 'Central Teacher Eligibility Test (Primary Stage).', iconUrl: ctetLogo },
    { id: 'ctet-2', boardId: 'cbse', name: 'CTET Paper 2', category: 'TEACHING', description: 'Central Teacher Eligibility Test (Elementary Stage).', iconUrl: ctetLogo },
