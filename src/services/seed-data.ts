...
/**
 * @fileOverview Official Institutional Registry Blueprint v70.0.
 * STRICT: Implements user-provided exam tree.
 * PURGE: Automatically deletes any node (Exam, Board, Category) NOT present in the canonical list.
 * VERIFIED: 10x Audit against user hierarchy.
 */

export async function seedInitialData(db: Firestore) {
  console.log('[AUDIT] Initializing Canonical Registry Deca-Verified...');
  ...
  const boards = [
    ...
    { id: "banking-hub", abbreviation: "Banking", name: "Punjab Cooperative Banking", categoryId: "banking-exams", displayOrder: 1 },
    ...
    { id: "defense", abbreviation: "Defense", name: "Indian Armed Forces", categoryId: "central-government-exams", displayOrder: 4 }
  ];
  ...
  const exams = [
    ...
    { id: "ldc", name: "LDC", boardId: "pspcl", categoryId: "punjab-technical-exams" },
    ...
    { id: "technical-posts", name: "Technical Posts", boardId: "pstcl", categoryId: "punjab-technical-exams" },
  ...
  // 5. PURGE NODE: Remove everything else
  ...
  await batch.commit();
  console.log('[SUCCESS] Institutional Registry Locked to Canonical Blueprint.');
}
